...
# ----------------------------------------
def save_sample_png(sample_folder, sample_name, img_list, name_list, pixel_max_cnt = 255, order=0):
    ...
    axes[1].set_title = ("Generated Image, Baseline")
    axes[2].set_title = ("Generated Image, Ours")
    fig.tight_layout()
    save_img_name = sample_name + '.jpg'
    ...
    for i in range(len(img_list)):
        ...
        save_img_path = f'{i}/result_{order}.png'
